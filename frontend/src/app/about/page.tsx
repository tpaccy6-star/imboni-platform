...
export const metadata: Metadata = {
  title: "About Imboni Hub | Meet John TUYISHIME & TUYIRINGIRE Pacifique",
  description: "Learn about Imboni Hub's mission and the visionary team. Featuring CEO John TUYISHIME and Lead Developer TUYIRINGIRE Pacifique, bridging the gap for African scholars.",
  keywords: ["Imboni Hub", "John TUYISHIME", "TUYIRINGIRE Pacifique", "Scholarship Guidance", "African Scholars", "Lead Developer", "CEO Imboni"],
};
...
export default function AboutPage() {
  const jsonLd = {
    ...
    "@type": "AboutPage",
    "name": "About Imboni Hub",
    "description": "Information about Imboni Hub mission and team.",
    "mainEntity": {
      "@type": "Organization",
      ...
      "employee": [
        {
          ...
          "image": "https://imbonihub.com/Ceo.jpeg",
          "sameAs": [
            "https://x.com/TuyishimeJohnwa",
            "https://www.instagram.com/imboniapplyhub"
          ]
        },
        {
          "@type": "Person",
          ...
          "image": "https://imbonihub.com/Developer.jpg",
          "sameAs": [
            "https://x.com/Tuyipaccy",
            "https://www.instagram.com/tr_pacifique/"
          ]
        }
      ]
    }
    ...
    <main className="min-h-screen bg-white dark:bg-[#020617]">
      ...
      <section className="py-24 bg-white dark:bg-[#020617]">
        <div className="container mx-auto px-6 md:px-12 text-center">
          <h2 className="text-4xl font-bold text-[#0A2647] dark:text-white mb-4">Meet the <span className="text-[#E1B12C]">Leadership Team</span></h2>
          <p className="text-slate-500 dark:text-slate-400 text-lg max-w-2xl mx-auto mb-16">
            The visionary and technical minds behind Imboni Hub. Dedicated to empowering the next generation of global leaders.
          </p>
            ...
            {[
              ...
              <div key={i} className="group flex flex-col items-center bg-slate-50 dark:bg-white/5 p-8 rounded-[3rem] shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-slate-100 dark:border-white/10">
                <div className="w-32 h-32 bg-white dark:bg-slate-900 rounded-full mb-6 flex items-center justify-center text-5xl shadow-lg border-4 border-slate-50 dark:border-white/5 group-hover:scale-110 group-hover:border-[#E1B12C] transition-all duration-300 overflow-hidden">
                  {dev.image ? (
                    <img src={dev.image} alt={dev.name} title={dev.name} className="w-full h-full object-cover" />
                  ) : (
                    dev.icon
                  )}
                </div>
                ...
                <div className="flex items-center gap-3">
                  <a href={dev.socials.email !== '#' ? `mailto:${dev.socials.email}` : '#'} title={`Email ${dev.name}`} className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 hover:scale-110 hover:-translate-y-1 transition-all shadow-sm">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                  </a>
                  <a href={dev.socials.whatsapp !== '#' ? `https://wa.me/${dev.socials.whatsapp.replace('+', '')}` : '#'} title={`WhatsApp ${dev.name}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center text-slate-400 hover:text-green-500 hover:bg-green-50 dark:hover:bg-green-500/10 hover:scale-110 hover:-translate-y-1 transition-all shadow-sm">
                  ...
                  <a href={dev.socials.instagram} title={`Instagram ${dev.name}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center text-slate-400 hover:text-pink-500 hover:bg-pink-50 dark:hover:bg-pink-500/10 hover:scale-110 hover:-translate-y-1 transition-all shadow-sm">
